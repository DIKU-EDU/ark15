...
simplicities, subtleties, and the basic levels of abstraction in C. The
programs you will write will probably get as close to fiddling with bits as
a C program typically gets. At the same time, we will simulate hardware
components using higher level data structures.

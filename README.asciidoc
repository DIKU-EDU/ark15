...
choice for simulating higher level programming languages, e.g. Python or Ruby.
A programming language can be thought of as and advanced, abstract machine. The
...
operating system.  The next step is to try to build upon these changes in
the Operating Systems and Concurrent Programming course, and later, the
course on Computer Networks. These are held in the spring of 2016.

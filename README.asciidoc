...
C is not an unusual choice for simulating machines. C is often the language of
choice for simulating high-level programming languages, e.g.
https://github.com/python/cpython[Python] or https://github.com/ruby/ruby[Ruby]
— a programming language is really a kind of advanced, abstract machine.  The
topic of simulating programming languages however, is the subject matter for
...
languages in C. You should deem our use as merely a "hack" — learning C is part
of the learning objectives for this course.

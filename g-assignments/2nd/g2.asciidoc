...
imperative approach, converting phases into side-effect-free (except in terms
of using time and space) functions, implementing branching, jumping, and
forwarding in an "executive" (coordinator) fashion (which was already the case
anyway).
